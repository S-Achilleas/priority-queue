 ...
 */
public class PQmax implements PQInterface {
    /**
     ...
     * @param comparator
     */
    public PQmax(Comparator<Processor> comparator) {
        this.heap = (Processor[]) new Object[DEFAULT_CAPACITY + 1];
        this.size = 0;
     ...
     */
    private void grow() {
        Processor[] newHeap = (Processor[]) new Object[heap.length + AUTOGROW_SIZE];
